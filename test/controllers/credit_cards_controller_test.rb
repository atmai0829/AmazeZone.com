...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference("CreditCard.count") do
      post credit_cards_url, params: { credit_card: { card_number: @credit_card.card_number, cvv: @credit_card.cvv, expiration_date: @credit_card.expiration_date, name: @credit_card.name, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { card_number: @credit_card.card_number, cvv: @credit_card.cvv, expiration_date: @credit_card.expiration_date, name: @credit_card.name, user_id: @credit_card.user_id } }
